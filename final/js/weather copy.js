...
const apiURL2 = "//api.openweathermap.org/data/2.5/onecall?lat=40.530781&lon=-112.298279&appid=647deaef50861934976f3e67d4453af9&units=imperial";
...
fetch(apiURL2)
    ...
    let tr_3 = document.createElement("tr");
        ...
        for (i = 0; i < forecastInfo.daily.length; i++) {
            var daily = forecastInfo.daily[i].temp.dt_txt;

            if (daily.includes('temp')){
